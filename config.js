...
export const DEV_DOMAIN = 'https://honouree.com/'
export const DEV_API = 'https://honouree.com/'
...
export const SCOT_TAG = ''
export const SCOT_TAG_FIRST = true
export const MAX_TAG = 15
...
export const SCOT_QUERY_LIMIT = 15
